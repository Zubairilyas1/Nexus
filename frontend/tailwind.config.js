  ...
  theme: {
    extend: {
      colors: {
        ...
        // Traffic-specific semantic colors
        traffic: {
          car: 'hsl(var(--traffic-car))',
          truck: 'hsl(var(--traffic-truck))',
          bus: 'hsl(var(--traffic-bus))',
          motorcycle: 'hsl(var(--traffic-motorcycle))',
          bicycle: 'hsl(var(--traffic-bicycle))',
          pedestrian: 'hsl(var(--traffic-pedestrian))',
        },
        // Zone states
        zone: {
          active: 'hsl(var(--zone-active))',
          inactive: 'hsl(var(--zone-inactive))',
          hover: 'hsl(var(--zone-hover))',
          dwell: 'hsl(var(--zone-dwell))',
        },
        // Status colors
        status: {
      ...
      fontSize: {
        ...
        'mono-sm': ['0.8125rem', { lineHeight: '1.5', fontFamily: 'var(--font-mono)' }],
        'mono-md': ['0.9375rem', { lineHeight: '1.5', fontFamily: 'var(--font-mono)' }],
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
      ...
      boxShadow: {
        ...
        'glow-status': '0 0 15px hsl(var(--status-online) / 0.4)',
      },
      transitionDuration: {
        '0': '0ms',
        '75': '75ms',
